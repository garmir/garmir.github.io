...
## Community Infrastructure Flags

**--self-host**
- Trigger: Local infrastructure requests, avoiding cloud dependencies, "host locally", "self-hosted"
- Behavior: Prioritize self-hosted alternatives, local data storage, community-controlled infrastructure

**--mesh**
- Trigger: Distributed coordination needs, P2P operations, "mesh network", "decentralized"
- Behavior: Use mesh networking protocols, decentralized discovery, peer-to-peer coordination

**--privacy-first**
- Trigger: Data sensitivity, surveillance concerns, "privacy", "no tracking", "anonymous"
- Behavior: Maximum privacy tools, minimal data collection, encrypted communications

**--community**
- Trigger: Collective development, mutual aid requests, "collaborative", "shared resources"
- Behavior: Shared resources while maintaining individual autonomy, mutual aid patterns

**--local-only**
- Trigger: Data sovereignty needs, offline operations, "offline-first", "local control"
- Behavior: All operations remain within local infrastructure, no external dependencies